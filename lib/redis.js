...
RedisModel.prototype = {
  ...
  queryUrl: function(long_url, fn) {
    this.db.get(this.kUrl(long_url), (err, reply) => typeof fn === 'function' && fn(err, reply))
  },
  queryHash: function(short_url, fn) {
    this.db.hgetall(this.kHash(short_url), (err, reply) => typeof fn === 'function' && fn(err, reply))
  },
  click: function(short_url, fn) {
    this.db.hincrby(this.kHash(short_url), 'clicks', 1, (err, reply) => typeof fn === 'function' && fn(err, reply))
  },
  ...
  get: function(short_url, fn, click) {
    const _this = this
